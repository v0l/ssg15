...
var g_rgIconMap = {
	...
	"ability_5": 					{ icon: 'media/:happycyto:' },
	"ability_6": 			{ icon: 'media/:lucky:' },
	"ability_7": 							{ icon: 'media/:lunahealthpotion:' },
	"ability_8": 			{ icon: 'media/:goldstack:' },
	"ability_9": 				{ icon: 'media/:hourglass:' },
	"ability_10": 			{ icon: 'media/:abomb:' },
	"ability_11": 				{ icon: 'media/:gmbomb:' },
	"ability_12": 				{ icon: 'media/:burned:' },
	"ability_13": 						{ icon: 'media/:alive:' },
	"ability_14": 							{ icon: 'media/:logiaim:' },
	"ability_15": 							{ icon: 'media/:pjkaboom:' },
	"ability_16": 				{ icon: 'media/:theorb:' },
	"ability_17": 						{ icon: 'media/:ccgold:' },
	"ability_18": 	{ icon: 'media/:critical:'  },
	"ability_19": 				{ icon: 'media/:fistpump:'  },
	"ability_20": 						{ icon: 'media/:VeneticaGoldCoin:' },
	"ability_21": 					{ icon: 'media/:swshield:' },
	"ability_22":		 					{ icon: 'media/:treasurechest:' },
	"ability_23":		 				{ icon: 'media/:healthvial:' },
	"ability_24":		 				{ icon: 'media/:sunportal:' },
	"ability_25":		 				{ icon: 'media/:twteamrandom:' },
	"ability_26":		 					{ icon: 'media/:wormwarp:' },
	"ability_27":	 					{ icon: 'http://cdn.steamcommunity.com//economy/emoticon/:cooldown:' },
	"element_1":									{ icon: 'media/:shelterwildfire:' },
	"element_2":									{ icon: 'media/:waterrune:' },
	"element_3":										{ icon: 'media/:Wisp:' },
	"element_4":									{ icon: 'media/:FateTree:' },
	"enemy_2":									{ icon: 'media/:like_king:' },
	"enemy_4":								{ icon: 'media/:goldenmilkminer:' },
};
